...
This is a single-page application where users can manage a To-Do list.

## ✅  Features

-   Users can add tasks to the list, and delete them by clicking on the correspondent checkbox.
