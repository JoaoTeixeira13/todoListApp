...
const srvr = process.env.DB_USERNAME;
const srvrCred = process.env.DB_PASSWORD;

//connect to a new MongoDB server

mongoose.connect("mongodb+srv://" + srvr +":" + srvrCred + "@cluster0.4jpv1.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
